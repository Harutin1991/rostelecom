...
@section('content')
    <form method="POST" action="{{ route('services.store') }}">
        ...
        <div class="form-group row">
            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Select Connected Services') }}</label>
            <div class="col-md-6">
                <select name="connected_services_id[]" id="connected_services_id" multiple="multiple">
